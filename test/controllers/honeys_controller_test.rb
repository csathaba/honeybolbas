...
class HoneysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create honey" do
    assert_difference('Honey.count') do
      post honeys_url, params: { honey: { description_de: @honey.description_de, description_en: @honey.description_en, name: @honey.name } }
    end
  ...
  test "should update honey" do
    patch honey_url(@honey), params: { honey: { description_de: @honey.description_de, description_en: @honey.description_en, name: @honey.name } }
